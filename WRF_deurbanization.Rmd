...
1 to 9 June 2009 temporal averages.  _**Note these plots show the first nine days of the WRF runs.**_
...
deurb = xr.open_dataset('/Users/tim/work/Data/SummenWRF/deurbanized/d02_deurb_month_mean_vals.nc',
                       mask_and_scale=True)
# ctl = xr.open_dataset('/Users/tim/work/Data/SummenWRF/deurbanized/d02_ctl_10day_mean_vals.nc')
# deurb = xr.open_dataset('/Users/tim/work/Data/SummenWRF/deurbanized/d02_deurb_10day_mean_vals.nc')
d = ctl - deurb
...
def make_layout(urban, d, varname):
    ...
    dmin = -1.0 * dmax
    print('{}: {} - {}'.format(varname, dmin, dmax))
