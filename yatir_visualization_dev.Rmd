...
```{python}
reload(spqd)
spqd.three_panel_quadmesh_compare_vertical_var(ds_diff, 'W')
```

```{python}
reload(spqd)
spqd.three_panel_quadmesh_compare_vertical_var(ds_diff, 'theta')
```

```{python}
reload(spqd)
spqd.three_panel_quadmesh_compare_surface_var(ds_diff, 'FSA')
```

```{python}
spqd.three_panel_quadmesh_compare_surface_var(ds_diff, 'FIRA')
```

```{python}
spqd.three_panel_quadmesh_compare_surface_var(ds_diff, 'HFX')
```

```{python}
spqd.three_panel_quadmesh_compare_surface_var(ds_diff, 'LH')
```
