...
def get_quadmesh_slider(hour_select, z_select):
    """
    """
    qm = ds_diff['W'].sel(WRFrun='control',
                     hour=hour_select,                         
...
```{python}
pn.Row(pn.Column(hour_select, z_select, get_quadmesh_slider), get_quadmesh_slider)
```
