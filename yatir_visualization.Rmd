...
z_select = pn.widgets.IntSlider(start=0, end=25, value=2, name='vertical level')
...
```{python}
pn.pane.Markdown("""W vertical wind component
""")
pn.Row(pn.Column(get_quadmesh_control, hour_select, z_select), 
       get_quadmesh_yatir,
       get_quadmesh_diff)
```
